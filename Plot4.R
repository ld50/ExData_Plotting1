...
plot(y=dt$Voltage, x=dt$Stamp, ylab="Voltage", xlab="datetime", type="l")
...
plot(y=dt$Global_reactive_power, x=dt$Stamp, ylab="Global_reactive_power", xlab="datetime", type="l")
